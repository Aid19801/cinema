...
function emailCheck() {
    ...
    var e = document.forms["signup"]["emailAddress"];
    var eValue = document.forms["signup"]["emailAddress"].value;
...
function CheckP() {
    ...
    var pass2 = document.forms["signup"]["ConfirmPassword"];
    var form = document.forms["signup"];
    var passw = /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{4,15}$/;
    // must have 1 digit, must have 1 lower case,
    // must have 1 upper case, must have 4-15 characters
